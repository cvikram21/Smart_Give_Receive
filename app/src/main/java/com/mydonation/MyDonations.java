...
public class MyDonations extends AppCompatActivity {
    ...
    public void getrecords() {
        ...
        String url = "http://possakrishna.com/Donation/getmydonations.php";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Toast.makeText(MyDonations.this,response,Toast.LENGTH_LONG).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(MyDonations.this,"No Internet",Toast.LENGTH_LONG).show();
            }
        }){
            @Override
            protected Map<String, String> getParams() {
                ...
                sharedPreferences = MyDonations.this.getSharedPreferences("donation", Context.MODE_PRIVATE);
...
// Add the request to the RequestQueue.
    ...
    private void parseServerJsonData(String response) {//Step -2
        ...
        try {
            ...
            for (int i = 0; i < jArray.length(); i++) {
                ...
                hm.put("donatedto", jObj.getString("requestedBy"));
            ...
            lv.setAdapter(new MyDonations.CustomAdapter(this, student_info));//Step -4
    ...
    public class CustomAdapter extends BaseAdapter {   //Step -3
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            tv4.setText("Donated to: "+hm.get("donatedto"));
