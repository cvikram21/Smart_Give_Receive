...
public class inbox extends AppCompatActivity {
    ...
    public  void getrecords() {
        ...
        String url = "http://possakrishna.com/Donation/inbox.php";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                       ...
                       // Toast.makeText(inbox.this,response,Toast.LENGTH_LONG).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(inbox.this,"No Internet",Toast.LENGTH_LONG).show();
            }
        }){
            @Override
            protected Map<String, String> getParams() {
                ...
                sharedPreferences = inbox.this.getSharedPreferences("donation", Context.MODE_PRIVATE);
    ...
    private void parseServerJsonData(String response) {//Step -2
        ...
        try {
            ...
            for (int i = 0; i < jArray.length(); i++) {
                ...
                hm.put("DonateName", jObj.getString("DonateName"));
//                hm.put("Number", jObj.getString("Number"));

                student_info.add(hm);
            }
            lv.setAdapter(new inbox.CustomAdapter(this, student_info));//Step -4
    ...
    public class CustomAdapter extends BaseAdapter {   //Step -3
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            if(convertView==null){
                convertView = inflater.inflate(R.layout.inboxmail, null);
            }
            ...
            TextView tv1=(TextView) convertView.findViewById(R.id.etingetitem);
            tv1.setText(hm.get("Item"));

            TextView tv2=(TextView) convertView.findViewById(R.id.etingetmsg);
            tv2.setText(hm.get("Msg"));

            TextView tv3=(TextView) convertView.findViewById(R.id.etingetdate);
...
//            tv4.setText(hm.get("Number"));
           ...
           bt.setTag(hm.get("RequestId").toString());
            ...
            ImageView img=(ImageView)convertView.findViewById(R.id.imgnext);

            img.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {

                    //Toast.makeText(inbox.this,"hello",Toast.LENGTH_SHORT).show();

                    Intent i=new Intent(inbox.this,inboxdetails.class);
